...
type Disponibilidade interface {
	VerificarDispinibilidade(quantidadeSolicitada int, quantidadeDisponivel int) bool
}
...
func (f Fornecedor) VerificarDispinibilidade(quantidadeSolicitada int, quantidadeDisponivel int) bool {
